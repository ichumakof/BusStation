...
namespace CashierApp.ViewModels
{
    public class LoginViewModel : INotifyPropertyChanged
    {
        ...
        public event EventHandler<bool> RequestClose; // true = success, false = cancelled
        ...
        // Для простоты — string. Если нужно, можно заменить на SecureString.
        ...
        private async Task LoginAsync()
        {
            ...
            {
                IsBusy = true;
                // Если Authenticate синхронный — выполняем в фоне, чтобы UI не блокировался
    ...
    // Простейшие реализации RelayCommand / AsyncRelayCommand (можно вынести в утилиты)
